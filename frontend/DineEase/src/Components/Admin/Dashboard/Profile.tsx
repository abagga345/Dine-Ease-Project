...
export const Profile = () => {
    ...
    return (
      <div className="flex flex-col p-4 md:p-6 gap-6 md:gap-10 w-full md:w-[80%] mx-auto  items-center">
        <h1 className="text-brand-maroon font-serif font-semibold text-xl md:text-2xl">
          My Profile
        </h1>
        <div className="flex flex-col gap-6 md:gap-8 w-full">
          <div className="flex flex-col md:flex-row gap-4 md:gap-4 justify-between items-center text-brand-ink bg-white p-4 md:p-8 rounded-2xl border border-brand-cream-dark shadow-card">
            <div className="flex flex-col md:flex-row gap-4 md:gap-8 items-center justify-between w-full">
              <div className="flex flex-col md:flex-row items-center gap-10">
                <img
                  ...
                  alt="profile"
                  className="aspect-square w-[78px] rounded-full object-cover ring-2 ring-brand-turmeric"
                />
                <div className="flex flex-col md:items-start items-center text-center md:text-left">
                  ...
                  <p className="text-brand-ink-soft text-md">{globaluser?.email}</p>
                  {(globaluser.storeId!=="")?<p className="text-brand-ink-soft text-md">{globaluser.storeId}</p>:""}
                </div>
              </div>
          ...
          <div className="flex flex-col gap-4 justify-between items-center text-brand-ink bg-white p-4 md:p-8 rounded-2xl border border-brand-cream-dark shadow-card w-full">
            <div className="flex flex-col gap-6 justify-between w-full">
              <div className="flex flex-row w-full justify-between items-center sm:gap-8">
                <p className="text-xl font-serif text-brand-maroon">Profile Details</p>
                <button
                  onClick={() => {
              ...
              <div className="flex flex-col md:flex-row w-full">
                <div className="flex flex-col gap-4 md:gap-8 w-full">
                  ...
                  <div>
                    <p>Email</p>
                    <p className="text-brand-ink-soft">{globaluser?.email}</p>
                  </div>
