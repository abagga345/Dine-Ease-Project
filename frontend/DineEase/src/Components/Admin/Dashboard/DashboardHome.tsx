...
export function DashboardHome(){
    ...
    return (
        <div className="bg-white p-8 rounded-2xl border border-brand-cream-dark m-6 lg:w-[55%] mx-auto shadow-card sm:w-[85%]">
          <div>
            <h1 className="text-3xl font-serif font-bold mb-5 text-brand-maroon flex items-center gap-2">
              <MdDashboard className="inline" /> Welcome to the Dashboard
            </h1>
            <hr className="my-4 border-brand-cream-dark" />
            <h2 className="text-lg mt-4 mb-6 text-brand-ink-soft">
